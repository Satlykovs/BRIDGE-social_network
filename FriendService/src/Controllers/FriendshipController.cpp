...
namespace friendship_service{
    ...
    FriendshipRequestDecisionHandler::FriendshipRequestDecisionHandler(const userver::components::ComponentConfig& config, const userver::components::ComponentContext& context) :
    HttpHandlerJsonBase(config, context),
    FriendshipManager_(context.FindComponent<FriendshipManager>()) {}

    userver::formats::json::Value FriendshipRequestDecisionHandler::HandleRequestJsonThrow(
        const userver::server::http::HttpRequest& request,
        const userver::formats::json::Value& request_json,
        userver::server::request::RequestContext& context) const{
    ...
    void AddFriendshipController(userver::components::ComponentList& component_list)
    {
        component_list
