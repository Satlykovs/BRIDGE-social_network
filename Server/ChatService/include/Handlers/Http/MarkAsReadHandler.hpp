...
namespace chat_service::http_handlers
{
	...
	class MarkAsReadHandler final
		: public userver::server::handlers::HttpHandlerJsonBase
	{
	   public:
		static constexpr std::string_view kName = "mark-as-read-handler";

		MarkAsReadHandler(const userver::components::ComponentConfig& config,
	   ...
	   private:
		...
		bool IsValidMessageInConversation(int64_t message_id,
