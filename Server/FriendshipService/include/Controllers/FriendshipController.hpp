...
namespace friendship_service
{
	...
	class GetStatusFriendshipRelationHandler final
		: public userver::server::handlers::HttpHandlerJsonBase
	{
	   public:
		...
		GetStatusFriendshipRelationHandler(
			const userver::components::ComponentConfig& config,
			const userver::components::ComponentContext& context);
	...
	class RemoveFriendHandler final
		: public userver::server::handlers::HttpHandlerJsonBase
	{
	   public:
	...
	class RevokeFriendshipRequestHandler final
		: public userver::server::handlers::HttpHandlerJsonBase
	{
	   public:
		static constexpr std::string_view kName =
		...
		RevokeFriendshipRequestHandler(
			const userver::components::ComponentConfig& config,
			const userver::components::ComponentContext& context);
	...
	class SendFriendshipRequestHandler final
		: public userver::server::handlers::HttpHandlerJsonBase
	{
	   public:
		static constexpr std::string_view kName =
	...
	class FriendshipRequestDecisionHandler final
		: public userver::server::handlers::HttpHandlerJsonBase
	{
	   public:
		static constexpr std::string_view kName =
		...
		FriendshipRequestDecisionHandler(
			const userver::components::ComponentConfig& config,
			const userver::components::ComponentContext& context);
	...
	void AddFriendshipController(
		userver::components::ComponentList& componenr_list);
