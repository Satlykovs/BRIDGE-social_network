...
namespace profile_service::managers
{
    class ProfileManager final : public userver::components::ComponentBase
    {
        public:
            ...
            ProfileManager(const userver::components::ComponentConfig& config, const userver::components::ComponentContext& context);
        ...
        private:
            ...
            const std::string baseUrl = "https://storage.yandexcloud.net/bridge-bucket/";
    };
}
